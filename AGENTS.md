...
This file provides guidance to agentic coding assistants (such as OpenAI Codex) when working with code in this repository. It mirrors `CLAUDE.md` — the two are kept in sync by the `agents-doc-sync` workflow.
